...
import myface from '../assets/12-years-old-me-lq.png'
      ...
      <div className="block-about-me">
        ...
        <div className="story-container">
          <div className="story-title"><h1>about me</h1></div>
              ...
              <p>
              I graduated in computer networks in 2012 and went on producing <a className="link" target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=YjjmM3w2t_g">electronic music</a>,
              but computer logic and programming languages always stuck as my main influences. After years working in the music scene, I went back to my first love: Coding.
              </p>
            <p>You may think a transition from music to tech is a big leap. Well, you're right, but having a strong web presence and insatiable <a className="link" target="_blank" rel="noopener noreferrer" href="https://github.com/remigallego/Certifications">desire to learn</a> makes it possible
           ...
           <p>I find my creative satisfaction with tools like <b className="bold">React</b> and <b className="bold">Bootstrap</b>, always eager to challenge myself in a field I have been passionate about my entire life.
            ...
            <div className="image mx-auto"  title="Aaaah... The 2000s..."><img alt="Me at 12 years old" src={myface}/></div>
          </div>
      </div>
      </div>
    )
